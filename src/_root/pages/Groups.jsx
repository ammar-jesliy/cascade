...
const Groups = ({ onCreateGroup, groups }) => {
  ...
  return (
    <div className='hidden md:flex flex-col w-80 bg-bg h-[100vh] shadow p-8 justify-between overflow-y-auto'>
        <div>
            ...
            <div className='flex items-center gap-3 mb-12 mt-7'>
                    ...
                    <li key={group.id} className='group'>
                        ...
                        >
                            <svg 
                                ...
                                className={`fill-current text-grey2 group-hover:text-grey1 transition ${isActive && `text-grey1`}`} 
