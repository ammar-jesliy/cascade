            ...
            <div>
                ...
                <div className="flex flex-wrap justify-center sm:flex-nowrap sm:items-center sm:justify-between mt-8 gap-8">
                    ...
                    <div className="flex w-full justify-between sm:w-[54%]">
                        <p className="text-primary text-[10px] font-normal sm:text-[14px]">&copy; Cascade {new Date().getFullYear()}</p>
                        <p className="text-primary text-[10px] font-normal sm:text-[14px]">Made with &#x2764; by <a className="underline text-accent1" href="https://ammarjesliy.netlify.app/" target="_blank">Ammar</a></p>
                    </div>
                </div>
            </div>
        </Section>
